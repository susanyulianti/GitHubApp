...
class FollowingGitHubAccountFragment: Fragment(R.layout.follow_fragment) {

    private var _binding: FollowFragmentBinding? = null
    private val binding get() = _binding!!

    private lateinit var viewModel: FollowingGitHubAccountViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ).get(FollowingGitHubAccountViewModel::class.java)
        viewModel.setListAccountFollowing(username)
        viewModel.getListAccountFollowing().observe(viewLifecycleOwner, {
            if (it != null) {
